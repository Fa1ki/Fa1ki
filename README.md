...
<div>
    <img src="https://skills-icons.vercel.app/api/icons?i=rust,cpp,cmake,python,qtwidgets,java,kotlin,gradle,js,ts,html,css,vite,vitepress,bun,npm,pnpm,git,md,svg,docker,github,gitlab,windows,powershell,vscode,visualstudio,intellijidea,androidstudio&perline=10"/>
